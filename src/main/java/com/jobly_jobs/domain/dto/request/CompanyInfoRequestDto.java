...
public record CompanyInfoRequestDto(
        ...
        @Size(min = 1, max = 50, message = "website must be between 1 and 50 characters") @Pattern(regexp =
                                                                                                           VALID_WEBSITE_REGEX, message = "website address should look like 'www.example.com'") String companyWebsite,
