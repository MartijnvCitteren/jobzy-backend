...
public record ContactInfoVacancyRequestDto(
    @Size(max = 25, message = "Name length should be shorter then 25 characters.") String name,
    @Size(max = 50, message = "Email length should be shorter then 50 characters.") @Pattern(regexp = EMAIL_REGEX
