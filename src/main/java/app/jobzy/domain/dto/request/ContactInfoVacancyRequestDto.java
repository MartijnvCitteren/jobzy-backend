...
import static app.jobzy.validation.ValidationRegex.EMAIL_REGEX;
import static app.jobzy.validation.ValidationRegex.PHONE_REGEX;
...
public record ContactInfoVacancyRequestDto(
    ...
    @Size(max = 15, message = "Phone number length should be shorter than 15 characters")
